...
const addReading = async (deviceId, sampleTime, temp) => {
  try {
    ...
    console.log('Added new reading to db', { deviceId, sampleTime, temp });
  } catch (err) {
...
const buildQueryParams = (deviceId, { since, limit }) => {
  ...
  if (typeof since === 'number') {
    params = {
      ...
      KeyConditionExpression: 'deviceId = :deviceId and sampleTime >= :since',
